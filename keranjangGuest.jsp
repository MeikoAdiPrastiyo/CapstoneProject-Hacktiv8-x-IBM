...
<head>
    ...
    <title>Keranjang Belanja - Guest</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p class="subtitle">Kelola produk pilihan Anda sebagai guest</p>
        </div>
        ...
        <div class="guest-notice">
            ...
            <h5>Mode Guest - Belanja Tanpa Registrasi</h5>
            <p>Anda sedang berbelanja sebagai guest. Login untuk menyimpan keranjang dan menikmati fitur lengkap.</p>
        </div>
        ...
        <%
                ...
                // Database connection untuk ambil detail barang
        ...
        <%
                    for (Map.Entry<Integer, Integer> entry : cart.entrySet()) {
                        ...
                        String sql = "SELECT nama_barang, harga FROM barang WHERE id = ?";
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="quantity-controls">
                                        <button class="quantity-btn" onclick="updateQuantity(<%= barangId %>, <%= quantity - 1 %>)">
                                ...
                                <td>
                                    <button class="btn-remove" onclick="removeItem(<%= barangId %>, '<%= namaBarang %>')">
    ...
    <script>
        ...
        function updateQuantity(barangId, newQuantity) {
            ...
            window.location.href = 'updateKeranjangGuest.jsp?barang_id=' + barangId + '&quantity=' + newQuantity;
        }
        
        function removeItem(barangId, namaBarang) {
            // Store delete data
            deleteData = {
                barangId: barangId,
        ...
        function confirmDelete() {
            if (deleteData.barangId) {
                window.location.href = 'hapusKeranjangGuest.jsp?barang_id=' + deleteData.barangId;
            }
        }
